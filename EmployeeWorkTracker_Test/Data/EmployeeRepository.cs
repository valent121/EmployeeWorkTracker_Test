...
namespace EmployeeWorkTracker_Test.Data
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public async Task<Employee> GetEmployee(int id)
        {
            ...
            //if (includeWorkHours)
            //{
            //    result = _context.Employees.Where(e => e.Id == id);
            //}
            //else
            //{
            //    result = _context.Employees.Where(e => e.Id == id).Include(w => w.WorkHours);
            //}
        ...
        public async Task<Employee[]> GetAllEmployees()
        {
            ...
            //if (includeWorkHours)
            //{
            //    result = _context.Employees.OrderBy(e => e.LastName);
            //}
            //else
            //{
            //    result = _context.Employees.OrderBy(e => e.LastName).Include(w => w.WorkHours);
            //}
